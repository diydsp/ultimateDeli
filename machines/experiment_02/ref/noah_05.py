...
#num_iterations = 5000
internal_dims = int( args.internal_dims )
#internal_dims = 3   # internal dimensions
#internal_dims = 7   # internal dimensions
#internal_dims = 20   # internal dimensions
BATCH_SIZE = 500
